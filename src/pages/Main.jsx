...
<div>
    ...
    />
          ...
          <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column',height:"auto",width:"100%" }}>
            ...
            <Toolbar sx={{ display: 'flex', justifyContent: 'space-between',gap:0, alignItems: 'center' ,paddingLeft:0,paddingRight:0,margin:0,borderBottom: '0.5px solid rgba(255, 255, 255, 0.3)',boxShadow: '0 2px 4px rgba(255, 255, 255, 0.2)',
  ...
  {/* Search Field */}
<div style={{width:"30%",backgroundColor:"white",height:"100%",marginRight:"0",margin:0,padding:0,borderBottomRightRadius: "28px", 
  ...
  {/* Navigation Items */}
<div style={{width:"50%",backgroundColor:"transparent",height:"100%",display:"flex",justifyContent:"center",alignItems:"center",      borderTopLeftRadius: "18px", 
...
<div style={{display:"flex",flexDirection:"row",marginTop:"20px"}}>
    <Box sx={{position:"relative",display:"flex",justifyContent:"start" ,
    alignItems: "start"}}>
        ...
        <Button sx={{width:"130px",height:"40px",border:"2px solid white",borderRadius:"30px",padding:"3",paddingLeft:"5px",paddingRight:"5px",color:"white",fontSize:"12px"}}>
            ...
            >
              <Typography variant="h3" fontWeight="bold" gutterBottom sx={{fontFamily:"Crete Round, serif",fontWeight:"200",textAlign:"left",fontSize:"68px"}}>
